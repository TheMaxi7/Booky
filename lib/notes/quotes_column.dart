...
import 'package:booky/notes/edit_quote.dart';
import 'package:booky/data_and_classes/quote.dart';
import 'package:expandable_text/expandable_text.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class BookQuotes extends StatefulWidget {
  const BookQuotes({super.key, required this.quotes});
...
class _BookQuotesState extends State<BookQuotes> {
    ...
    for (int i = 0; i < widget.quotes.length; i++) {
      ...
      final quoteCard = GestureDetector(
        onLongPressStart: (value) {
          _showDropDownMenu(
              context, value.globalPosition, widget.quotes, quote);
        },
        child: Card(
  ...
  void _showDropDownMenu(
      BuildContext context, Offset offset, List<Quote> quotes, Quote quote) {
