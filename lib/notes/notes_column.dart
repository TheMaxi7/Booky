...
import 'package:booky/notes/edit_note.dart';
...
class BookNotes extends StatefulWidget {
  const BookNotes({super.key, required this.notes});
...
class _BookNotesState extends State<BookNotes> {
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      note.name.isNotEmpty ? note.name : "Quote ${note.index}:",
  ...
  void _showDropDownMenu(
      BuildContext context, Offset offset, List<Note> notes, Note note) {
