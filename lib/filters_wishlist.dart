...
import 'package:booky/filtered_wishlist.dart';
...
class FiltersWishlist extends StatefulWidget {
  const FiltersWishlist({Key? key}) : super(key: key);
              ...
              onPressed: () {
                if (_selectedGenreIndex != -1) {
                  setState(() {
                    ...
                    filteredBooks = dataManager.filterWishlist(manager.myWishlist[_selectedGenreIndex].genre);
                  });
                }
                Navigator.push(
                    context,
