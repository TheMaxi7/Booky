...
class NewQuote extends StatefulWidget {
  const NewQuote({Key? key, required this.book}) : super(key: key);
  final Book book;
  @override
              ...
              child: ElevatedButton(
                onPressed: () {
                  setState(() {
                    ...
                    dataManager.addNewQuote(widget.book,
                        titleController.text, quoteController.text, pageNumber!, _isFavourite);
