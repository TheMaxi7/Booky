...
class SearchInExplore extends StatefulWidget {
  const SearchInExplore({Key? key, required this.searchList,required this.searchString}) : super(key: key);
  final List<Book> searchList;
  final String searchString;
  @override
  State<SearchInExplore> createState() => _SearchInExploreState();
}

class _SearchInExploreState extends State<SearchInExplore> {
  @override
